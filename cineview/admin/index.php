				...
				<div class="col-12 col-sm-6 col-xl-3">
					<div class="stats">
						...
						<p><?php if (AppCurrency == "") {
							...
							echo number_format($sales_today, 2);
							if (AppCurrency == "") {
				...
				<div class="col-12 col-sm-6 col-xl-3">
					<div class="stats">
						...
						<p><?php if (AppCurrency == "") {
							...
							echo number_format($sales_all_time, 2);
							if (AppCurrency == "") {
								print ' ' . strtoupper(AppISO) . '';
							} else {
							} ?></p>
											...
											<tr>
												...
												<td>
													<div class="main__table-text main__table-text--rate"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
														...
														</svg> <?php echo $rates; ?></div>
												</td>
												<td>
													<div class="main__table-text"><?php echo number_abbr($row[15]); ?></div>
												</td>
												<td>
													<div class="main__table-text main__table-text--<?php if ($row[16] == "Visible") {
																										print 'green';
																									} else {
																										print 'red';
																									} ?>">
											...
											<tr>
												...
												<td>
													<div class="main__table-text">
														<a href="edit-user?node=<?php echo $row[0]; ?>">
