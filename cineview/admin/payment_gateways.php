										...
										<div class="col-12 col-md-6 col-lg-12 col-xl-6">
											<div class="sign__group">
												...
												<select name="mode" required class="js-example-basic-single" id="paypal_box">
													<option <?php if ($paypal_status == "1") {
																print ' selected ';
															} ?> value="1">Live Mode
													</option>
													<option <?php if ($paypal_status == "0") {
																print ' selected ';
															} ?> value="0">Sandbox
													</option>
												</select>
										...
										<div class="col-12 col-md-6 col-lg-12 col-xl-6">
											<div class="sign__group">
												...
												<select name="status" required class="js-example-basic-single" id="ppbox">
													<option <?php if ($paypal_switch == "1") {
																print ' selected ';
															} ?> value="1">Enabled
													</option>
													<option <?php if ($paypal_switch == "0") {
																print ' selected ';
															} ?> value="0">Disabled
													</option>
												</select>
										...
										<div class="col-12 col-md-6 col-lg-12 col-xl-6">
											<div class="sign__group">
												...
												<select name="mode" required class="js-example-basic-single" id="stripe_box">
													<option <?php if ($stripe_status == "1") {
																print ' selected ';
															} ?> value="1">Live Mode
													</option>
													<option <?php if ($stripe_status == "0") {
																print ' selected ';
															} ?> value="0">Sandbox
													</option>
												</select>
										...
										<div class="col-12 col-md-6 col-lg-12 col-xl-6">
											<div class="sign__group">
												...
												<select name="status" required class="js-example-basic-single" id="stbox">
													<option <?php if ($stripe_switch == "1") {
																print ' selected ';
															} ?> value="1">Enabled
													</option>
													<option <?php if ($stripe_switch == "0") {
																print ' selected ';
															} ?> value="0">Disabled
													</option>
												</select>
