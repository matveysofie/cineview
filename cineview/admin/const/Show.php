            ...
            <table id="datatbl" class="main__table main__table--dash">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      <td>
                        <div class="main__table-text"><a target="_blank" href="<?php echo $row[2]; ?>"><?php echo $row[2]; ?></a></div>
                      </td>
                      <td>
                        <div class="main__table-text"><?php echo $row[3]; ?></div>
                      </td>
                      <td>
                        <div class="main__table-text"><?php if ($row[4] == "1") {
                                                        print '<c class="on">ON</c>';
                                                      } else {
                                                        print '<c class="off">OFF</c>';
                                                      } ?></div>
                      </td>
                      <td>
                        <div class="main__table-text">Episode <?php echo $row[5]; ?></div>
                      </td>
                      <td width="100">
