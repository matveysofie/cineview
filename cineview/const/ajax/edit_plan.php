        ...
        <div class="col-12">
          <div class="form__group">
            ...
            <select name="valid_type" required class="form__input form_control">
              <option <?php if ($row[4] == "Days") {
                        print 'selected';
                      } ?> value="Days">Days</option>
              <option <?php if ($row[4] == "Months") {
                        print 'selected';
                      } ?> value="Months">Months</option>
              <option <?php if ($row[4] == "Years") {
                        print 'selected';
        ...
        <div class="col-12">
          <div class="form__group">
            ...
            <select name="max_size" required class="form__input form_control">
              <option <?php if ($row[5] == "480") {
                        print 'selected';
                      } ?> value="480">480p</option>
              <option <?php if ($row[5] == "720") {
                        print 'selected';
                      } ?> value="720">720p</option>
              <option <?php if ($row[5] == "1080") {
                        print 'selected';
