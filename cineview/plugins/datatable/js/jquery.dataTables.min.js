...
(function(k) {
    ...
    function ma(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "No data available in database" === b.sEmptyTable && V(a, a, "sZeroRecords", "sEmptyTable");
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "<p style='color:white'>No data available in database</p>",
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "<p style='color:white'>No matching records found</p>"
        },
